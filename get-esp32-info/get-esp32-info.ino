...
AFFICHE QUELQUES CARACTÉRISTIQUES DE L’ESP32 DANS LA CONSOLE SÉRIE
====================================================================
...
void setup()
{
  ...
  // Serial.printf("ESP.getChipId()                : 0x%X\n", ESP.getChipId()); //  returns the ESP chip ID as a 32-bit integer.
